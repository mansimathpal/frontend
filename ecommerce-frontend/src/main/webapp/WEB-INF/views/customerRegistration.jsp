...
<li><label for="signup"><i class="fa fa-credit-card"></i>Customer Registration Page</label></li>
</ul>
</div>
<div class="section-out">
<section class="login-section">
<div class="login">
<form:form method="Post" action="addCustomer" commandName="instCustomer">
<ul class="ul-list">
<li><input type="number" required name="cartId" class="input" placeholder="cart Id"/><span class="icon"><i class="fa fa-lock"></i></span></li>
...
<li><input type="submit" value="Login Customer" class="btn"></li>
</ul>
</form:form>
</div>
</section>
